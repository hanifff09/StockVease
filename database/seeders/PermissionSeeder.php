...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $menuMaster = ['master', 'master-user', 'master-role', 'kategori', 'kondisi','item', 'peminjaman', 'raw', 'confirm', 'loan', 'late', 'done', 'cancel'];
        $menuWebsite = ['website', 'setting',];
        $menuStaff = ['item', 'raw', 'confirm', 'loan', 'late', 'done', 'cancel'];
