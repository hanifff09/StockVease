...
import ResetPass from "./tabs/ResetPass.vue";

 const routes = [
    {
        path: '/reset-pass', // Path yang harus diakses
        name: 'ResetPass',   // Nama rute
        component: ResetPass // Komponen yang akan dirender
    },
